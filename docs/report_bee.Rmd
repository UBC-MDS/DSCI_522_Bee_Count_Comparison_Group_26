...
```{r map, echo=FALSE, fig.cap="Map of bee sites for sample collection", fig.height=10, fig.width=10, out.width="85%"}
...
```{r plot_1_hist_bee_distribution, echo=FALSE, fig.cap="The distribution of bee counts at each site type", fig.height=10, fig.width=10, out.width="80%"}
...
```{r plot_2_violin_mean_median, echo=FALSE, fig.cap="The distribution of bee counts with the mean and median", fig.height=10, fig.width=10, out.width="80%"}
...
```{r plot_3_jitter, echo=FALSE, fig.cap="The distribution of the bees collected on different sites", fig.height=10, fig.width=10, out.width="100%"}
...
kable(results[,!names(results) %in% c("p.value")], caption = "Analysis results",
